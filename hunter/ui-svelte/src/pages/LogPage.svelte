<script lang="ts">
  ...
  function kindClass(kind: string): string {
    switch (kind) {
      case "job_done": return "kind-ok";
      case "job_failed": return "kind-bad";
      case "job_killed": return "kind-warn";
      case "job_denied": return "kind-stale";
      case "job_started": return "kind-accent";
      case "cycle": return "kind-accent";
      case "finding_new": return "kind-ok";
